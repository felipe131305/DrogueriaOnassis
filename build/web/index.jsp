        ...
        <div class="container center-block" >
            <div class="row justify-content-center">
                <div class="card" style="width: 18rem;">
                    <img src="drogueria.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <form method="POST" action="validar">
                            <div class="form-group">
                                <label>No de Documento</label>
                                <input type="number" class="form-control" name="txtusuario" required="digite el precio del producto">
                            ...
                            <c:if test="${Bandera ==1}">
                                <script>
                                    {
                                        alert("El usuario ingresado no se encuentra registrado o esta inactivo por favor verifeque nuevamente")
                                    }
                                </script>
                            </c:if>
