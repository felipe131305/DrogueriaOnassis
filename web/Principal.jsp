...
<html lang="en">
    ...
    <body >
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"href="Controlador?menu=Productos&accion=Listarp" target="miContenedor">Productos</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"href="Controlador?menu=Kardex&accion=Listarp" target="miContenedor">Kardex</a>
                    </li>
                    <li class="nav-item">
                        <a  class="nav-link"href="Controlador?menu=Reporte&accion=Reporte" target="miContenedor"">reporte</a>
                    </li>
                    <li class="nav-item">
                        <a  class="nav-link"href="Controlador?menu=Cliente_reporte&accion=Clienter" target="miContenedor"">reporte cliente</a>
                    </li>
                </ul>
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="#1" name="ID">${usuario.getId()}</a>
        ...
        <div class="m-10" style="height:900px; background: url(Drogueria.png)" >
