        ...
        <div class="row">
            <div class="card col-md-4" style="background: url(registro.png)">
                <div class="card-body" >
                    ...
                    <b <h6 class="card-subtitle mb-2 text-black">En este panel podras gestionar los datos de los usuarios empleados del sistema</h6> </b>
                    <div>
                        <form action="Controlador?menu=Empleados" method="POST">
                           
                            <div class="form-group">
                                <label>Documento</label>
                                <input type="number" class="form-control" name="txtdocumento" value="${usuarioSeleccionado.getDocumento()}"  min="0" max="99999999999999999" required="digite el precio del producto" >
